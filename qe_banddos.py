...
line1=plt.plot( eig[:,0]-efermi,color='r',lw=lw) 
for i in range(1,nbnd):
    line1=plt.plot( eig[:,i]-efermi,color='r',lw=lw ) 
...
line1=plt.plot( dos[:,1],dos[:,0]-efermi,color='r',lw=lw) 
plt.axhline(y=0 ,lw=lw,color='black',ls='--')
...
plt.savefig('pwbanddos.png',dpi=1000)
